  ...
  <html>
    ...
    <body>
      ...
      <div class="janela" id="fechar">
        ...
        <form action="{{ route('blogUpdate', $post->id) }}" method="POST">
          @csrf
            <div>
                <label for="titulo">Título</label>
                <input type="text" name="titulo" id="titulo" value="{{$post->titulo}}"/>
                <label for="html">Texto</label>
                <input type="text" name="html" id="html" value ="{{$post->html}}"/>
                <label for="criadoPor">Criador</label>
                <input type="number" name="criadoPor" id="criadoPor" value ="{{$post->criadoPor}}"/>
            </div>
      ...
      <footer class="rodape_pag">
       <ul class="redes_sociais">
        ...
        <a class="white-text" href="{{ URL::asset('https://br.freepik.com/fotos-vetores-gratis/escola') }}">Foto do header criado por jcomp - br.freepik.com</a> <br>
